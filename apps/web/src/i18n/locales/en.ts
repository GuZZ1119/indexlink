export default {
  ...
  dashboard: {
    ...
    decisionExplanation: {
      ...
      aiSource: 'Sentiment input: CNBC RSS headlines summarized by Qwen into a bounded score. The current model contract stores a score only and does not fabricate per-headline reasons.',
