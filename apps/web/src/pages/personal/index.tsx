    ...
    <div className="mx-auto w-full max-w-7xl space-y-8 px-5 py-8 md:px-8 lg:px-10 lg:py-10">
        ...
        <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.35fr_.65fr] lg:p-10">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <button type="button" className="rounded-full bg-white px-4 py-2.5 text-sm font-medium text-[#102028] transition-colors hover:bg-[#dcece4]">我已完成这次投入</button>
      ...
      <section className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="space-y-5">
          ...
          <StrategyCard strategy={strategy} selected onSelect={setActiveStrategyId} />
        </div>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <MiniStat icon={<CalendarDays />} label="今年完成" value="5 / 6 次" detail="下一次在 6 月 15 日" />
